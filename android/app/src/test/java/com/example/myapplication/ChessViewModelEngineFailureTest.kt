 ...
 *
 * These tests document and verify the null-return contract at the ViewModel
 * boundary - the behaviour a corrected NativeEngineProvider would exhibit if
 * it returned null on isLibraryLoaded=false.
 *
 * They do NOT fix or exercise the current JNI-unavailable production path.
 *
